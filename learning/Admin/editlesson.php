...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="course_name">file_name</label>
      <input type="text" class="form-control" id="file_name" name="file_name" onkeypress="isInputNumber(event)" value="<?php if(isset($row['file_name'])) {echo $row['file_name']; }?>" readonly>
    </div>
    <div class="form-group">
      <label for="course_name">download_link</label>
      <input type="text" class="form-control" id="download_link" name="download_link" onkeypress="isInputNumber(event)" value="<?php if(isset($row['download_link'])) {echo $row['download_link']; }?>" readonly>
    </div>
    <div class="form-group">
