...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
   ...
   $sql = "UPDATE course SET course_id = '$cid', course_name = '$cname', course_desc = '$cdesc', course_author='$cauthor', course_duration='$cduration', course_price='$cprice', course_original_price='$coriginalprice', course_purchase_link='$course_purchase_link', course_img='$cimg' WHERE course_id = '$cid'";
 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="course_purchase_link" name="course_purchase_link" row=2><?php if(isset($row['course_purchase_link'])) ?></textarea>
    </div>
    <div class="form-group">
