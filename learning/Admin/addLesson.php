 ...
 if(isset($_REQUEST['lessonSubmitBtn'])){
  ...
  if(($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
   ...
   move_uploaded_file($lesson_link_temp, $link_folder);
    $sql = "INSERT INTO lesson (lesson_name, lesson_desc, lesson_link, course_id, course_name,file_name,download_link) VALUES ('$lesson_name', '$lesson_desc','$link_folder', '$course_id', '$course_name', '$file_name', '$download_link')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="lesson_desc">File Name</label>
      <textarea class="form-control" id=file_name" name="file_name" row=2></textarea>
    </div>
    <div class="form-group">
      <label for="lesson_desc">Download link</label>
      <textarea class="form-control" id="download_link" name="download_link" row=2></textarea>
    </div>
    <div class="form-group">
